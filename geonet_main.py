...
flags.DEFINE_integer("num_source",                   2,    "Source image sequence length for each example")
flags.DEFINE_integer("num_scales",                   4,    "Depth of image scale pyramid")
...
flags.DEFINE_boolean("add_dispnet",              False,    "Add dispnet for training or testing")
flags.DEFINE_boolean("add_posenet",              False,    "Add posenet for training or testing")
...
flags.DEFINE_boolean("add_flownet",              False,    "Add flownet for training or testing")
